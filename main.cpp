...
int main()
{
    ...
    motorcycles.emplace_back("Lyell");
    motorcycles.emplace_back("Irene");

    trucks.reserve(2);
    trucks.emplace_back("Justin");
    trucks.emplace_back("Jason");
    ...
    for(auto& mCycle : motorcycles)
    {
        highway.addVehicle(&mCycle);
    }
